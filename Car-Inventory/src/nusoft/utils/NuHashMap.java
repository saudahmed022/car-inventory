...
public class NuHashMap<K, V> implements NuMap<K, V> {
  ...
  LinkedList<NuMap.Entry<K,V>>[] table;
   ...
   * default load factor */
  public NuHashMap(int initialCapacity) { 
    this(initialCapacity, DEFAULT_MAX_LOAD_FACTOR);    
  }
  
  /** Construct a map with the specified initial capacity 
   * and load factor */
  public NuHashMap(int initialCapacity, float loadFactorThreshold) { 
  ...
  public java.util.Set<NuMap.Entry<K,V>> entrySet() {
    java.util.Set<NuMap.Entry<K, V>> set = 
  ...
  public V put(K key, V value) {
    ...
    table[bucketIndex].add(new NuMap.Entry<K, V>(key, value));
